var _plugins = _plugins || {}; _plugins["plugins/login-embed"] =
webpackJsonp_plugins__name_([4],{
...
var _embed = __webpack_require__(1306);
...
function getServerCode(type, secret) {
    ...
    switch (type) {
        ...
        case "ruby":
            ...
            break;
        case "other":
            server = "Validate a JSON Web Token using the following specifications:\n    - Algorithm: HS256\n    - HMAC Secret: " + secret;
            break;
        default:
            break;
    }
...
var ResetConfig = function ResetConfig(props) {
    var handleSubmit = props.handleSubmit;
...
var LoginConfig = function (_React$Component) {
    (0, _inherits3.default)(LoginConfig, _React$Component);

    function LoginConfig(props) {
        (0, _classCallCheck3.default)(this, LoginConfig);

        var _this = (0, _possibleConstructorReturn3.default)(this, (LoginConfig.__proto__ || Object.getPrototypeOf(LoginConfig)).call(this, props));
    ...
    (0, _createClass3.default)(LoginConfig, [{
        key: "handleCopy",
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                ...
                                this.setState({ loading: false, secret: secret.secret, resetURL: options.reset_url, googleClientId: options.google_client_id });
        ...
        value: function render() {
            var _state = this.state,
                ...
                googleClientId = _state.googleClientId,
                resetURL = _state.resetURL,
            ...
            var submitPrep = function submitPrep(data) {
                console.log(data);
                return [{ option: "google_client_id", value: data.google_client_id }];
            };
            var submitPrepReset = function submitPrepReset(data) {
                console.log(data);
                return [{ option: "reset_url", value: data.reset_url }];
            };
            ...
            return _react2.default.createElement(
                ...
                !loading && _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                "The login embed will create an access token containing the user's data, this should be sent to your server for validation and session creation, for technical documentation ",
                                _react2.default.createElement(
                                    "a",
                                    { href: "https://docs.servicebot.io/login-embed" },
                                    "go here"
                                )
                            ),
                            _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "p",
                                { className: "form-help-text" },
                                "Reset URL should point to a page with the login embed, this is where users will be directed when they request a password reset "
                            ),
                            _react2.default.createElement(_servicebotBaseForm.ServicebotBaseForm, {
                                submissionPrep: submitPrepReset,
                                submissionRequest: submissionRequest,
                                form: ResetConfig,
                                successMessage: "Updated Reset URL",
                                formName: "reset_password_config",
                                reShowForm: true,
                                initialValues: { reset_url: resetURL.value }
                            }),
                            _react2.default.createElement("div", { className: "clear" })
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "p",
                                { className: "form-help-text" },
                                " In order to use the login so Servicebot can manage user login, and forgot password, you need to validate an access token on your server."
                            ),
                            _react2.default.createElement(
                                "select",
                    ...
                    _react2.default.createElement(
                        "div",
                        { id: "_section-5", className: "_section " + (serverType && '_active') },
                        _react2.default.createElement("span", { className: "caret" }),
                        _react2.default.createElement(
                            "h3",
                            null,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "p",
                                { className: "form-help-text" },
                                "Add your Google Client ID to enable logging in/signing up with a Google account"
                            ),
                            _react2.default.createElement(_servicebotBaseForm.ServicebotBaseForm, {
                                submissionPrep: submitPrep,
                                submissionRequest: submissionRequest,
                                form: GoogleConfig,
                                successMessage: "Updated Google Client ID",
                                formName: "login_embed_config",
                                reShowForm: true,
                                initialValues: { google_client_id: googleClientId.value }
                            }),
                            _react2.default.createElement("div", { className: "clear" })
                        )
                    )
...
var _default = { component: LoginConfig, name: "Login Page", description: "Login!!!", iconUrl: "data:image/svg+xml;utf8,<svg width=\"56px\" height=\"56px\" viewBox=\"0 0 56 56\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\">\n    <!-- Generator: Sketch 51.3 (57544) - http://www.bohemiancoding.com/sketch -->\n    <title>SB-Icon-Login</title>\n    <desc>Created with Sketch.</desc>\n    <defs></defs>\n    <g id=\"SB-Icon-Login\" stroke=\"none\" stroke-width=\"1\" fill=\"none\" fill-rule=\"evenodd\">\n        <g id=\"log-in\" transform=\"translate(8.000000, 8.000000)\" fill=\"#4C82FC\" fill-rule=\"nonzero\">\n            <path d=\"M26.5294118,3.97941185 C25.6636242,3.97941185 24.9617646,3.27755232 24.9617646,2.41176471 C24.9617646,1.54597709 25.6636242,0.844117561 26.5294118,0.844117561 L34.5686275,0.844117561 C37.6543832,0.844117561 40.1558824,3.34561683 40.1558824,6.43137255 L40.1558824,34.5686275 C40.1558824,37.6543832 37.6543832,40.1558824 34.5686275,40.1558824 L26.5294118,40.1558824 C25.6636242,40.1558824 24.9617646,39.4540229 24.9617646,38.5882353 C24.9617646,37.7224477 25.6636242,37.0205881 26.5294118,37.0205881 L34.5686275,37.0205881 C35.922808,37.0205881 37.0205881,35.922808 37.0205881,34.5686275 L37.0205881,6.43137255 C37.0205881,5.07719205 35.922808,3.97941185 34.5686275,3.97941185 L26.5294118,3.97941185 Z\" id=\"Shape\"></path>\n            <path d=\"M15.7407923,11.32441 C15.147412,10.6939435 15.1774764,9.70181963 15.8079429,9.10843936 C16.4384095,8.51505909 17.4305333,8.54512345 18.0239136,9.17558999 L27.6709724,19.42559 C28.2390877,20.0292125 28.2390877,20.9707875 27.6709724,21.57441 L18.0239136,31.82441 C17.4305333,32.4548765 16.4384095,32.4849409 15.8079429,31.8915606 C15.1774764,31.2981804 15.147412,30.3060565 15.7407923,29.67559 L24.3766417,20.5 L15.7407923,11.32441 Z\" id=\"Shape\"></path>\n            <path d=\"M26.5294118,18.9323529 C27.3951994,18.9323529 28.0970589,19.6342124 28.0970589,20.5 C28.0970589,21.3657876 27.3951994,22.0676471 26.5294118,22.0676471 L2.41176471,22.0676471 C1.54597709,22.0676471 0.844117561,21.3657876 0.844117561,20.5 C0.844117561,19.6342124 1.54597709,18.9323529 2.41176471,18.9323529 L26.5294118,18.9323529 Z\" id=\"Shape\"></path>\n        </g>\n    </g>\n</svg>" };
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(getServerCode, "getServerCode", "/usr/src/app/plugins/login-embed/embed.js");

    __REACT_HOT_LOADER__.register(clientCode, "clientCode", "/usr/src/app/plugins/login-embed/embed.js");

    __REACT_HOT_LOADER__.register(GoogleConfig, "GoogleConfig", "/usr/src/app/plugins/login-embed/embed.js");

    __REACT_HOT_LOADER__.register(ResetConfig, "ResetConfig", "/usr/src/app/plugins/login-embed/embed.js");

    __REACT_HOT_LOADER__.register(LoginConfig, "LoginConfig", "/usr/src/app/plugins/login-embed/embed.js");

    __REACT_HOT_LOADER__.register(_default, "default", "/usr/src/app/plugins/login-embed/embed.js");
}();
