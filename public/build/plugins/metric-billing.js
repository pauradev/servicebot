var _plugins = _plugins || {}; _plugins["plugins/metric-billing"] =
webpackJsonp_plugins__name_([9],{
...
var _component = __webpack_require__(1296);
    ...
    return _regenerator2.default.wrap(function run$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.next = 2;
                    return provide({ tierBillingOverride: _component.Override });
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(run, "run", "/usr/src/app/plugins/metric-billing/client.js");
}();
...
var _tierBillingForm = __webpack_require__(569);
...
var Override = function (_React$Component) {
    (0, _inherits3.default)(Override, _React$Component);

    function Override(props) {
        (0, _classCallCheck3.default)(this, Override);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Override.__proto__ || Object.getPrototypeOf(Override)).call(this, props));

        _this.toggleMetricPricing = _this.toggleMetricPricing.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(Override, [{
        key: "componentDidUpdate",
        value: function componentDidUpdate(prevProps, prevState) {
            console.log(prevProps.selected);
            if (prevProps.selected === this.props.selected && this.props.tier.name !== prevProps.tier.name) {
                var metric = this.props.formJSON.references.service_template_properties && this.props.formJSON.references.service_template_properties.find(function (prop) {
                    return prop.type === "metric";
                });
                if (metric) {
                    var index = metric.config.pricing.tiers.indexOf(prevProps.tier.name);
                    if (index >= 0) {
                        metric.config.pricing.tiers[index] = this.props.tier.name;
                    }
                }
            }
        }
    }, {
        key: "toggleMetricPricing",
        value: function toggleMetricPricing(e) {
            e.preventDefault();
            var defaultMetric = {
                "type": "metric",
                "data": {
            ...
            var templateProps = this.props.formJSON.references.service_template_properties || [];
            var metricIndex = templateProps.findIndex(function (prop) {
                return prop.type === "metric";
            });
            if (metricIndex === -1) {
                metricIndex = templateProps.length;
            }
            var metric = templateProps[metricIndex] || defaultMetric;
            var tierIndex = metric.config.pricing.tiers.indexOf(this.props.tier.name);
            if (tierIndex >= 0) {
                metric.config.pricing.tiers.splice(tierIndex, 1);
            } else {
                metric.config.pricing.tiers.push(this.props.tier.name);
            }
            this.props.changeMember("references.service_template_properties[" + metricIndex + "]", metric);
        }
    }, {
        key: "render",
        value: function render() {
            var _props = this.props,
                ...
                tier = _props.tier,
                service_template_properties = _props.formJSON.references.service_template_properties;

            console.log(tier);
            var metricIndex = (service_template_properties || []).findIndex(function (prop) {
                return prop.type === "metric";
            });
            var metric = (service_template_properties || [])[metricIndex];

            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement(
                    _tierBillingForm.TierBillingForm,
                    this.props,
                    tier.type === "subscription" && _react2.default.createElement(
                        "div",
                        { className: '' },
                        _react2.default.createElement(
                            "div",
                            { className: "form-group --metric-billing" },
                            _react2.default.createElement(
                                "label",
                                { className: "control-label" },
                                "Metric Billing is ",
                                metric && metric.config.pricing.tiers.includes(tier.name) ? 'On' : 'Off'
                            ),
                            _react2.default.createElement(
                                "button",
                                { className: "buttons _add _toggle-metric-billing", onClick: this.toggleMetricPricing },
                                metric && metric.config.pricing.tiers.includes(tier.name) ? 'Turn Off' : 'Turn On'
                            )
                        ),
                        metric && metric.config.pricing.tiers.includes(tier.name) && _react2.default.createElement(
                            "div",
                            null,
                            _react2.default.createElement(_reduxForm.Field, { name: "service_template_properties[" + metricIndex + "].config.unit", type: "text",
                                component: _servicebotBaseForm.inputField, label: "Metric Name (User, Seat, etc)",
                                validate: [(0, _reduxFormValidators.required)()]
                            }),
                            _react2.default.createElement(_reduxForm.Field, { name: "service_template_properties[" + metricIndex + "].config.isSeat", type: "checkbox",
                                component: _servicebotBaseForm.inputField, label: "Is Metric Connected to Users?"
                            })
                        )
                    )
                )
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(Override, "Override", "/usr/src/app/plugins/metric-billing/component.jsx");
}();
...
exports.TierBillingForm = undefined;
...
var PaymentStructureTemplates = function PaymentStructureTemplates(props) {
    var fields = props.fields,
        tier = props.tier,
        member = props.member,
        setPricingTemplates = props.setPricingTemplates;

    var plans = fields.getAll() || [];
    ...
    var availableOptions = [{ id: "month", name: "Monthly" }, { id: "year", name: "Yearly" }, { id: "day", name: "Daily" }, { id: "week", name: "Weekly" }];
    var optionMap = plans.map(function (plan) {
        return availableOptions.filter(function (option) {
            return option.id === plan.interval || !plans.some(function (plan2) {
                return plan2.interval === option.id;
            });
        });
    });
    // ].filter(option => {
    ...
    if (tier.type === "custom") {
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                "p",
                null,
                "Quotes are built for services that are customer specific. If your service is priced based on the customer's use-case, use this option. Once the quote service has been requested by the customer, you can add charges to the service at anytime."
            )
        );
    }
    if (tier.type === "one_time") {
        return _react2.default.createElement(
            ...
            fields.map(function (field, index) {
                if (index === 0) {
                    return _react2.default.createElement(_reduxForm.Field, { key: "field-" + index + "-" + member, name: field + ".amount", type: "number",
                        component: _servicebotBaseForm.priceField,
                        isCents: true,
                        label: "Amount",
                        validate: (0, _reduxFormValidators.numericality)({ '>=': 0.00 }) });
                } else {
                    return null;
                }
            })
    ...
    if (tier.type === "subscription") {
        return _react2.default.createElement(
            "div",
            { className: "payment-structures" },
            fields.map(function (field, index) {
                return _react2.default.createElement(
                    "div",
                    { key: "field-" + index + "-" + member },
                    index > 0 && _react2.default.createElement(
                        "div",
                        { className: "_billing-options" },
                        _react2.default.createElement(
                            "span",
                            { className: "_count" },
                            index + 1
                        ...
                        _react2.default.createElement(
                            "span",
                            { className: "_sub-heading" },
                            "Billing Option ",
                            index + 1
                        ),
                        _react2.default.createElement("div", { className: "_hr" }),
                        fields.length > 1 && _react2.default.createElement("button", { className: "_billing-options-delete",
                            "aria-label": "delete billing option " + (index + 1),
                            onClick: deletePlan(index) })
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "_billing-options-fields" },
                        _react2.default.createElement(_reduxForm.Field, { name: field + ".amount", type: "number",
                            component: _servicebotBaseForm.priceField,
                            isCents: true,
                            label: "Amount",
                            validate: (0, _reduxFormValidators.numericality)({ '>=': 0.00 }) }),
                        ...
                        _react2.default.createElement(_reduxForm.Field, { name: field + ".interval", id: "interval", label: "Billed", component: _servicebotBaseForm.selectField,
                            options: optionMap[index] })
                    )
                );
            }),
            plans.length < 4 && _react2.default.createElement(
                "button",
                { className: "buttons _add", onClick: addPayment },
...
var TierBillingForm = function TierBillingForm(props) {
    var tier = props.tier,
        member = props.member,
        setPricingTemplates = props.setPricingTemplates,
        serviceTypeValue = props.serviceTypeValue;

    var changeServiceType = function changeServiceType(event, newValue) {
        var pricingStructures = tier.references && tier.references.payment_structure_templates || [];
        setPricingTemplates(member, pricingStructures.map(function (p) {
            return (0, _extends3.default)({}, p, {
                type: newValue
            });
        }));
    };
    var changeTrial = function changeTrial(event, newValue) {
        var pricingStructures = tier.references && tier.references.payment_structure_templates || [];
        setPricingTemplates(member, pricingStructures.map(function (p) {
            return (0, _extends3.default)({}, p, {
    ...
    var formatFromPricing = function formatFromPricing(value, name) {
        var pricingStructures = tier.references && tier.references.payment_structure_templates || [];
    ...
    return _react2.default.createElement(
        "div",
        { className: "_tier-details" },
        _react2.default.createElement(
            "div",
            { className: '_basic-details' },
            _react2.default.createElement(
                "div",
                { className: "_tier-name_name" },
                _react2.default.createElement(_reduxForm.Field, { name: member + ".name", type: "text",
                    component: _servicebotBaseForm.inputField, label: "Tier Name (eg. Basic, Enterprise)",
                    validate: [(0, _reduxFormValidators.required)()]
                })
            ),
            _react2.default.createElement(
                "div",
                { className: "_tier-name_type" },
                _react2.default.createElement(_reduxForm.Field, { name: member + ".type", id: "type",
                    component: _servicebotBaseForm.selectField, label: "Billing Type", onChange: changeServiceType,
                    options: [{ id: "subscription", name: "Subscription" },
                    // {id: "split", name: "Scheduled Payments"},
                    { id: "one_time", name: "One Time" }, { id: "custom", name: "Quote" }]
                })
            ),
            tier.type === "subscription" && _react2.default.createElement(
                "div",
                { className: "_tier-name_billing_period" },
                _react2.default.createElement(_reduxForm.Field, { onChange: changeTrial, format: formatFromPricing, name: member + ".trial_period_days", type: "number",
                    component: _servicebotBaseForm.inputField, label: "Trial Period (Days)",
                    validate: (0, _reduxFormValidators.required)()
                })
            )
        ),
        _react2.default.createElement(
            "div",
            { className: '_metric-settings' },
            props.children
        ),
        _react2.default.createElement(
            _reduxForm.FormSection,
            { name: member + ".references" },
            _react2.default.createElement(_reduxForm.FieldArray, { name: "payment_structure_templates",
                props: { tier: tier, member: member },
                component: PaymentStructureTemplates })
        )
    );
};
exports.TierBillingForm = TierBillingForm;
;
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(PaymentStructureTemplates, "PaymentStructureTemplates", "/usr/src/app/views/components/elements/forms/tier-billing-form.jsx");

    __REACT_HOT_LOADER__.register(TierBillingForm, "TierBillingForm", "/usr/src/app/views/components/elements/forms/tier-billing-form.jsx");
}();
